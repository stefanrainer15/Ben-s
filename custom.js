...
$(document).ready(function() {
  ...
  $("#team-slider").owlCarousel({
    ...
    //by default there are 3 slides display.
    //the slides will change automatically.
    //speed of changing wil be 700
    //infinite loop; after the last slide, first slide starts
    autoplayHoverPause: true, //when you put mouse over Carousel, slide changing will stop
    responsive: {
      //responsiveness as screen size changes
      // min-width: 0px
      0: {
